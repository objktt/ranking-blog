...
import { audioHeadphonesTop10 } from '@/data/templates';
...
export default function HeadphonesTop10() {
  const template = audioHeadphonesTop10;
  const cards = productCards.slice(0, 5);
